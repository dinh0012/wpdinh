...
class Contact extends WP_Widget{
  public function __construct() {
      ...
      public function update($new_instance, $old_instance)
    {
        ...
        $instance['phone_ct'] = strip_tags($new_instance['phone_ct']);
      ...
      public function form( $instance ) {
        ...
        ?>
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="" name="<?= $nameTitle;?>" value="<?=$valTitle; ?>" placeholder="Title">
          </div>
          <div class="form-group">
            <label for="">Name</label>
            <input type="text" class="form-control" id="" name="<?= $nameName;?>" value="<?=$valName; ?>" placeholder="Name">
          </div>
          <div class="form-group">
            <label for="">Email</label>
            <input type="text" class="form-control" id="" name="<?= $nameEmail;?>" value="<?=$valEmail; ?>" placeholder="Email">
          </div>
          <div class="form-group">
            <label for="">Phone </label><i class="glyphicon glyphicon-plus-sign icon_add"></i>
            <input type="text" class="form-control" id="" name="<?= $namePhone;?>" value="<?=$valPhone; ?>" placeholder="Phone">
            <input type="text" class="form-control" id="" name="<?= $namePhone;?>" value="<?=$valPhone; ?>" placeholder="Phone">

          </div>
          <div class="form-group">
            <label for="">Fax</label>
            <input type="text" class="form-control" id="" name="<?= $nameFax;?>" value="<?=$valFax; ?>" placeholder="Fax">
          </div>

          <div class="form-group">
            <label for="">Address</label>
            <textarea name="<?= $nameAddress;?>" id="input" class="form-control" rows="3"><?=$valAddress; ?></textarea>
          </div>
